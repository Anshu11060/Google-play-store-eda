...
-->>Objectives
  ...
  *Identify most popular app categories
   ...
   *Detect missing values and clean the dataset
...
*Apps with higher reviews tend to have higher installs

*Free apps significantly outnumber paid apps

*Some categories consistently receive better ratings
...
-->>Outcome
*This project demonstrates data cleaning, visualization, and analytical skills using real-world data.
